...
# o professor deve digitar primeiro as notas dos 25 alunos que têm número ímpar na chamada 
# (1, 3, 5..., 47, 49) e depois as notas dos 25
# alunos que têm número par (2, 4, 6..., 48, 50).
...
for alunoPar in range(2, 51, 2):
    ...
    print("=============================================")
    inputNotaPar = float(input(f"POR FAVOR, INSIRA A NOTA DO ALUNO DE NÚMERO {alunoPar}: "))
    notaParSoma =  notaParSoma + inputNotaPar 

notaParMedia = notaParSoma / 25

for alunoImp in range(1, 50, 2):
    print("VOCÊ ESTÁ DIGITANDO AS NOTAS DOS ALUNOS IMPARES")
    print("=============================================")
    inputNotaImp = float(input(f"POR FAVOR, INSIRA A NOTA DO ALUNO DE NÚMERO {alunoImp}: "))
    notaImpSoma =  notaImpSoma + inputNotaImp 

notaImpMedia = notaImpSoma / 25

print("=============================================")
print(f"A media dos alunos pares foi {notaParMedia}, ja a media dos alunos impares foi {notaImpMedia}")
print("=============================================")

if notaParMedia > notaImpMedia:
